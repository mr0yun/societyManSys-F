<template>
  <div class="page-wrapper">
    <el-table :data="filterTableData" stripe style="width: 100%" size="default">
      ...
      <el-table-column label="经手人" prop="founder" width="80" />
      <el-table-column label="类型" prop="recruit_eligible" width="100">
        <template #default="scope">
          <el-tag size="default" :type="scope.row.recruit_eligible ? 'success' : 'danger'">{{
            scope.row.recruit_eligible ? "收入" : "支出"
          }}</el-tag>
        </template>
      </el-table-column>
      <el-table-column label="金额（元）" prop="id" width="100"/>
      <el-table-column label="记录时间" prop="founding_date" width="180" />
