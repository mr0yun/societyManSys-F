<template>
  <div class="page-wrapper">
    <el-table :data="filterTableData" stripe style="width: 100%" size="default">
      ...
      <el-table-column label="标题" prop="name" width="80" />
      <el-table-column label="关联id" prop="name" width="80" />
      <el-table-column label="申请人id" prop="name" width="80" />
      <el-table-column label="内容" prop="name" width="80" />
      <el-table-column label="状态" prop="recruit_eligible" width="100">
      ...
      <el-table-column label="图片链接" prop="name" width="80" />
      <el-table-column label="文件链接" prop="name" width="80" />
      <el-table-column label="申请时间" prop="name" width="120" />
      <el-table-column label="批复时间" prop="classification" width="120" />
      <el-table-column label="批复意见" prop="president" />
